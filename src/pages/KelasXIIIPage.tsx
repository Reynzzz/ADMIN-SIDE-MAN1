...
export default function KelasXIIIPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-primary">Kelas XIII</h1>
          <p className="text-muted-foreground">Kelola data siswa kelas XIII</p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Daftar Siswa Kelas XIII</CardTitle>
          <CardDescription>Kelola data siswa kelas XIII</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-md border">
            ...
            <div className="divide-y">
              {[
                { nisn: "2020001", nama: "Arif Budiman", kelas: "XIII-A", jk: "L", status: "Aktif" },
                { nisn: "2020002", nama: "Sari Dewi", kelas: "XIII-A", jk: "P", status: "Aktif" },
                { nisn: "2020003", nama: "Budi Santoso", kelas: "XIII-B", jk: "L", status: "Aktif" },
                { nisn: "2020004", nama: "Lestari Ningrum", kelas: "XIII-B", jk: "P", status: "Aktif" },
                { nisn: "2020005", nama: "Hendra Wijaya", kelas: "XIII-C", jk: "L", status: "Aktif" },
              ].map((siswa, index) => (
